...
object Icons {
    ...
    val Llama: Icon = getIcon("/icons/llama.svg", Icons::class.java)

    val OpenAI: Icon = getIcon("/icons/openai_dark.svg", Icons::class.java)

    val MCP: Icon = getIcon("/icons/mcp.svg", Icons::class.java)

    val Mention: Icon = getIcon("/icons/mention.svg", Icons::class.java)

    val Meta: Icon = getIcon("/icons/meta.svg", Icons::class.java)
